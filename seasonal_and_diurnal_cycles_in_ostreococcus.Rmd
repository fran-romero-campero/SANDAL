...
boxplot(ld.normalized.proteomic.data[,2:55],las=2,col=rep(rainbow(6),each=9),
        outline = F,main="After Normalization",cex.main=2)
...
barplot(data.proteins.ld, lwd=2, names.arg = "",cex.names = 2,cex.axis = 1.5,
        col=c("blue", "white"), 
        border="black", 
        font.axis=2, 
...
barplot(data.proteins.sd, lwd=2, names.arg = "",cex.names = 2,cex.axis = 1.5,
        col=c("red", "white"), 
        border="black", 
        font.axis=2, 
        xlab="",ylim=c(0,3500)) #178 445
