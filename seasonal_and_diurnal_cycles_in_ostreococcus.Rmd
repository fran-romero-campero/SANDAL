...
hist(circacompare.ld.ll[,"Phase difference estimate"],xlab="Phase Difference estimate (h)",ylab="Number of Genes", col="lightblue",border="blue",main="",lwd=2)
...
hist(-circacompare.ld.dd[,"Phase difference estimate"],xlab="Phase Difference estimate (h)",ylab="Number of Genes", col="darkblue",border="blue",main="",lwd=2)
...
hist(-circacompare.sd.ll[,"Phase difference estimate"],xlab="Phase Difference estimate (h)",ylab="Number of Genes", col="lightblue",border="blue",main="",lwd=2)
...
hist(-circacompare.sd.dd[,"Phase difference estimate"],xlab="Phase Difference estimate (h)",ylab="Number of Genes", col="darkblue",border="blue",main="",lwd=2)
