...
```
We found that 45.22% of the genes identified previously as rhythmic under LD conditions still presented cycling expression patterns when transferred to free running conditions consisting of constant light (LL). Specifically, we identified 2804 circadian genes under LD conditions comprising 36.57% of the entire genome. The 33397 remaining genes cycling under LD conditions presented either a flat or noisy expression profile under LL conditions.      
...
We found that 53.39% of the genes identified previously as rhythmic under LD conditions still presented cycling expression patterns when transferred to free running conditions consisting of constant darkness. Specifically, we identified 3311 circadian genes under LD conditions comprising 53.39% of the entire genome. The 2890 remaining genes cycling under LD conditions presented either a flat or noisy expression profile under DD conditions.      

```{r ld_dd_activated_repressed_by_darkness}
non.rhythmic.ld.dd.mean.expression.cycle <- apply(X = gene.expression[non.rhythmic.ld.dd.genes,ld.zt.i],MARGIN = 1,FUN = mean)

non.rhythmic.ld.dd.mean.expression.dd <- apply(X = gene.expression[non.rhythmic.ld.dd.genes,ld.dd.zt.i],MARGIN = 1,FUN = mean)
...
ld.no.clear.effect.dark <- setdiff(non.rhythmic.ld.dd.genes, 
                                   c(ld.dark.activated,ld.dark.repressed))
length(ld.no.clear.effect.dark)
```

```{r ld_ll_activated_repressed_by_light}
non.rhythmic.ld.ll.mean.expression.cycle <- apply(X = gene.expression[non.rhythmic.ld.ll.genes,ld.zt.i],MARGIN = 1,FUN = mean)

non.rhythmic.ld.ll.mean.expression.ll <- apply(X = gene.expression[non.rhythmic.ld.ll.genes,ld.ll.zt.i],MARGIN = 1,FUN = mean)
...
ld.no.clear.effect.light <- setdiff(non.rhythmic.ld.ll.genes, 
...
non.rhythmic.sd.dd.mean.expression.cycle <- apply(X = gene.expression[non.rhythmic.sd.dd.genes,sd.zt.i],MARGIN = 1,FUN = mean)

non.rhythmic.sd.dd.mean.expression.dd <- apply(X = gene.expression[non.rhythmic.sd.dd.genes,sd.dd.zt.i],MARGIN = 1,FUN = mean)
...
non.rhythmic.sd.ll.mean.expression.cycle <- apply(X = gene.expression[non.rhythmic.sd.ll.genes,sd.zt.i],MARGIN = 1,FUN = mean)

non.rhythmic.sd.ll.mean.expression.ll <- apply(X = gene.expression[non.rhythmic.sd.ll.genes,sd.ll.zt.i],MARGIN = 1,FUN = mean)
